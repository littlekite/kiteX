...
pub fn game_setup(
    ...
    .spawn((PlayerBundle::new(
        ...
        0.2,
        vec![
            vec![200.0,90.0,275.,90.],
            vec![275.0,90.0,290.0,85.0],
            vec![290.0,85.0,310.0,75.0],
            vec![310.0,75.0,330.0,70.0],
            vec![330.0,70.0,450.0,70.0],
            vec![450.0,70.0,500.0,85.0],
            vec![500.0,85.0,600.,90.],    
        ]
    )));
    ...
    commands
        .spawn(TilemapBundle::new(
            ...
            vec![
                ...
                vec![181,182,183,184,185,186,187,188,189,190,191,192,193,194,195,196,197,198,199,200],
